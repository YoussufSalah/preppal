...
import { FileText, Scale, Shield, AlertTriangle, Users, Gavel, CheckCircle, XCircle, Mail, Calendar } from 'lucide-react';
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Welcome to PrepPal! These terms govern your use of our AI-powered study platform. Please read them carefully.
          </p>
          ...
          <div className="p-8 md:p-12">
            ...
            <div className="mb-12">
              ...
              <div className="bg-gradient-to-r from-blue-50 to-purple-50 p-6 rounded-xl">
                <p className="text-gray-700 leading-relaxed">
                  By accessing or using <strong className="text-blue-600">PrepPal</strong>, you agree to be bound by these Terms of Use and our Privacy Policy. If you do not agree to these terms, please do not use our service. These terms create a legally binding agreement between you and PrepPal.
                </p>
              </div>
            </div>
            ...
            <section className="mb-12">
              <div className="flex items-center mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900">Use of the Service</h2>
              </div>
              
              <div className="space-y-6">
                <div className="border-l-4 border-green-500 pl-6">
                  <h3 className="text-lg font-semibold text-gray-900 mb-2">What PrepPal Offers</h3>
                  <p className="text-gray-600 mb-3">
                    PrepPal is an AI-powered educational platform that transforms your study materials into interactive learning tools:
                  </p>
                  <ul className="text-gray-600 space-y-1">
                    <li>• AI-generated summaries from uploaded PDFs and documents</li>
                    <li>• Personalized flashcards based on your content</li>
                ...
                <div className="border-l-4 border-blue-500 pl-6">
                  <h3 className="text-lg font-semibold text-gray-900 mb-2">Your Responsibilities</h3>
                  <p className="text-gray-600 mb-3">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-gradient-to-br from-purple-50 to-pink-50 p-6 rounded-xl">
                  ...
                  <ul className="text-gray-600 space-y-2">
                    <li>• You retain full ownership of all materials you upload</li>
                    <li>• PrepPal does not claim ownership of your content</li>
                    <li>• You can delete your content at any time</li>
                    <li>• Export your generated study materials anytime</li>
                  </ul>
                </div>
                
                <div className="bg-gradient-to-br from-blue-50 to-cyan-50 p-6 rounded-xl">
                  <h3 className="text-lg font-semibold text-gray-900 mb-3">License to Process</h3>
                  <ul className="text-gray-600 space-y-2">
                    <li>• You grant us permission to process your content</li>
                    <li>• Processing is limited to providing our services</li>
                    <li>• We use your content to generate summaries and quizzes</li>
                    <li>• Original files are not permanently stored</li>
                  </ul>
                </div>
              </div>
              ...
              <div className="mt-6 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                <div className="flex items-center">
                  ...
                  <p className="text-sm text-yellow-800">
                    <strong>Important:</strong> You are responsible for ensuring you have the right to upload and process any content you submit to PrepPal. Do not upload copyrighted materials without proper authorization.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section className="mb-12">
              ...
              <div className="bg-gradient-to-r from-red-50 to-pink-50 p-6 rounded-xl mb-6">
                <p className="text-gray-700 mb-4">
                  To maintain a safe and productive environment for all users, you agree not to engage in the following activities:
                </p>
              </div>
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <div className="border border-red-200 rounded-lg p-6">
                  ...
                  <h3 className="font-semibold text-gray-900 mb-2">Harmful Content</h3>
                ...
                <div className="border border-orange-200 rounded-lg p-6">
                  ...
                  <h3 className="font-semibold text-gray-900 mb-2">System Interference</h3>
                  <ul className="text-sm text-gray-600 space-y-1">
                ...
                <div className="border border-purple-200 rounded-lg p-6">
                  ...
                  <h3 className="font-semibold text-gray-900 mb-2">Account Misuse</h3>
                  <ul className="text-sm text-gray-600 space-y-1">
            ...
            <section className="mb-12">
              <div className="flex items-center mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900">Service Disclaimer</h2>
              </div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-gray-700">
                      PrepPal uses artificial intelligence to generate study materials. While we strive for accuracy, AI-generated content may contain errors, omissions, or inaccuracies. You should always verify important information and use our materials as supplementary study aids.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">
                      Our service is designed for educational purposes only. PrepPal does not guarantee academic success, test performance, or educational outcomes. Your learning success depends on various factors beyond our control.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">
                      We strive to maintain high service availability but cannot guarantee uninterrupted access. PrepPal may experience downtime for maintenance, updates, or technical issues.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <section className="mb-12">
              ...
              <div className="bg-gradient-to-r from-indigo-50 to-blue-50 p-6 rounded-xl">
                <div className="space-y-4">
                  <p className="text-gray-700">
                    To the fullest extent permitted by law, PrepPal and its affiliates shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising from or related to your use of our service, including but not limited to:
                  </p>
                  ...
                  <p className="text-gray-700">
                    Our total liability for any claims arising from these terms or your use of PrepPal shall not exceed the amount you paid for our service in the 12 months preceding the claim.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section className="mb-12">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-gradient-to-br from-gray-50 to-blue-50 p-6 rounded-xl">
                  ...
                  <ul className="text-gray-600 space-y-2">
                    ...
                    <li>• Cancel subscriptions through account settings</li>
              ...
              <div className="mt-6 p-4 bg-orange-50 border border-orange-200 rounded-lg">
                <p className="text-sm text-orange-800">
                  <strong>Effect of Termination:</strong> Upon termination, your access to PrepPal will cease immediately. You remain liable for any charges incurred before termination, and certain provisions of these terms will survive termination.
                </p>
              </div>
            </section>
            ...
            <section className="mb-12">
              ...
              <div className="bg-gradient-to-r from-teal-50 to-cyan-50 p-6 rounded-xl">
                <p className="text-gray-700 leading-relaxed">
                  We may update these Terms of Use from time to time to reflect changes in our service, legal requirements, or business practices. When we make material changes, we will notify you by email or through our platform at least 30 days before the changes take effect. Your continued use of PrepPal after the effective date constitutes acceptance of the updated terms.
                </p>
              </div>
            </section>
