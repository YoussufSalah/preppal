        ...
        <ProtectedRoute>
            <div className="min-h-screen relative overflow-hidden">
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50">
                    ...
                    <div
                        className="absolute top-32 right-20 w-24 h-24 bg-purple-200 rounded-full opacity-30 animate-bounce"
                        style={{ animationDelay: "1s" }}
                    ></div>
                    <div
                        className="absolute bottom-20 left-1/4 w-40 h-40 bg-pink-200 rounded-full opacity-25 animate-pulse"
                        style={{ animationDelay: "2s" }}
                    ></div>
                    <div
                        className="absolute bottom-32 right-10 w-28 h-28 bg-blue-300 rounded-full opacity-20 animate-bounce"
                        style={{ animationDelay: "3s" }}
                    ></div>

                    {/* Floating Geometric Shapes */}
                    <div
                        className="absolute top-1/4 left-1/3 w-16 h-16 bg-gradient-to-r from-blue-400 to-purple-400 opacity-10 rotate-45 animate-spin"
                        style={{ animationDuration: "8s" }}
                    ></div>
                    <div
                        className="absolute top-3/4 right-1/3 w-12 h-12 bg-gradient-to-r from-purple-400 to-pink-400 opacity-15 animate-spin"
                        style={{
                    ...
                    ></div>
                    <div
                        className="absolute top-1/2 left-20 w-20 h-20 bg-gradient-to-r from-pink-400 to-blue-400 opacity-10 rotate-12 animate-pulse"
                        style={{ animationDelay: "2s" }}
                    ></div>

                    {/* Animated Gradients */}
                    <div
                        className="absolute top-0 left-0 w-96 h-96 bg-gradient-to-br from-blue-400 to-transparent opacity-10 rounded-full animate-pulse"
                        style={{ animationDuration: "4s" }}
                    ></div>
                    <div
                        className="absolute bottom-0 right-0 w-80 h-80 bg-gradient-to-tl from-purple-400 to-transparent opacity-10 rounded-full animate-pulse"
                        style={{
                    ...
                    ></div>
                    <div
                        className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-gradient-to-r from-pink-400 to-transparent opacity-10 rounded-full animate-pulse"
                        style={{
                            animationDuration: "6s",
                            animationDelay: "2s",
                        }}
                    ...
                    {/* Floating Icons */}
                    <div
                        className="absolute top-16 right-1/4 opacity-10 animate-bounce"
                        style={{ animationDelay: "0.5s" }}
                    >
                        <FileText className="w-8 h-8 text-blue-600" />
                    </div>
                    <div
                        className="absolute bottom-1/4 left-16 opacity-10 animate-bounce"
                        style={{ animationDelay: "1.5s" }}
                    >
                        <Brain className="w-10 h-10 text-purple-600" />
                    </div>
                    <div
                        className="absolute top-1/3 right-16 opacity-10 animate-bounce"
                ...
                <div className="relative z-10">
                    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                        ...
                        <div className="text-center mb-12">
                            ...
                            >
                                Upload your PDF and let our AI create summaries,
