...
export const metadata = {
    ...
    openGraph: {
        title: "PrepPal - Your Smart Study Companion",
        description:
            "PrepPal helps students learn better by summarizing PDFs and creating smart quizzes.",
    ...
    twitter: {
        ...
        title: "PrepPal - Your Smart Study Companion",
        description:
            "Summarize PDFs, highlight key points, and test your knowledge with quizzes.",
        images: ["/preppal-icon.png"],
    },
};
    ...
    return (
        <html lang="en" suppressHydrationWarning>
            <head>
                ...
                <meta
                    property="og:title"
                    content="PrepPal - Your Smart Study Companion"
                />
                <meta
